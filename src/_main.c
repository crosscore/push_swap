...
/*   Updated: 2023/02/19 10:45:07 by ysakahar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* main:
入力が正しいかどうかを確認します。
正しい場合は、スタックaとbを初期化し、各値のインデックスを割り当て、スタックを並べ替えます。
ソートが完了すると、スタックを解放して終了します。
*/
int	main(int argc, char **argv)
{
	...
	if (!is_input_formatted_correctly(new_argv))
		display_error_and_exit((t_stack **)&new_argv, NULL);
	stack_b = NULL;
